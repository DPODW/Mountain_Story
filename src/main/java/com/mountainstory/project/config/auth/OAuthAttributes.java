...
public class OAuthAttributes {
    ...
    private static OAuthAttributes ofKakao(String userNameAttributeName, Map<String, Object> attributes){
        log.info("카카오의 userNameAttributeName: {}",userNameAttributeName);
        OAuthAttributes KakaoAttribute = new OAuthAttributes(attributes,userNameAttributeName,null,null,null);
    ...
    private static OAuthAttributes ofNaver(String userNameAttributeName, Map<String, Object> attributes){
        log.info("네이버의 userNameAttributeName: {}",userNameAttributeName);
        OAuthAttributes NaverAttribute = new OAuthAttributes(attributes,userNameAttributeName,null,null,null);
    ...
    public Member toEntity(){
        ...
        member.createMemberInfo(email,name,LocalDateTime.now(),id,null);
        return member;
    }
}
